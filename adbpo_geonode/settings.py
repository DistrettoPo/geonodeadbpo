...
TEMPLATES[0]['OPTIONS']['context_processors'] += ['adbpo_geonode.themes.context_processors.custom_theme']
...
EPSG_CODE_MATCHES = {
    ...
    'EPSG:23032': '(23032) ED50 / UTM zone 32N',
    'EPSG:3035': '(3035) ETRS89 / ETRS-LAEA'
}
